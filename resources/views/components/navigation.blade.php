                ...
                <div class="flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <div class="ml-3 relative">
                            <x-splade-dropdown align="right" width="48">
                                ...
                                <x-slot:trigger>
                                    ...
                                    <div
                                        ...
                                        <div class="block px-4 py-2 text-xs text-gray-400">
                                            {{ __('Gerenciar Currículo') }}
                                        </div>

                                        {{--<x-dropdown-link :href="route('page.list')">
                                            {{ __('Lista') }}
                                        </x-dropdown-link>--}}
                                        <x-dropdown-link :href="route('resume.create')">
                                            {{ __('Criar') }}
                                        </x-dropdown-link>
                            ...
                            <x-splade-dropdown align="right" width="48">
                                ...
                                <x-slot:trigger>
                                    ...
                                    <div
                                        ...
                                        <!-- Account Management -->
                                        <div class="block px-4 py-2 text-xs text-gray-400">
                                            {{ __('Códigos de ativação') }}
                                        </div>

                                        {{--<x-dropdown-link :href="route('page.list')">
                                            {{ __('Lista') }}
                                        </x-dropdown-link>--}}
                                        <x-dropdown-link :href="route('code.create')">
                                            {{ __('Criar') }}
                                        </x-dropdown-link>
