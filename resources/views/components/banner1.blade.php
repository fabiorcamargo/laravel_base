<div class="relative bg-white overflow-hidden">
            ...
            <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    <h2
                        ...
                        Sua carreira
                        <br class="xl:hidden" />
                        <span class="text-indigo-600">no nível mais Alto</span>!
                    </h2>
                    <p
                        class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:leading-7 sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        No Portal de Carreiras crie o perfil profissional mais competitivo do mercado de trabalho.
                    </p>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img src="https://wallpapercave.com/wp/wp4447354.jpg"
